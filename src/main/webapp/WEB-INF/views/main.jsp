        ...
        <div class="row align-items-center text-center justify-content-center">
          <div class="col-lg-8 col-md-8">
           <!--  <a data-fancybox data-ratio="2" href="https://vimeo.com/317571768" class="play-button d-block">
            ...
            <br><br><br><br>
            <h1 class="text-uppercase" style="color: #0F4C81">AI</h1>
			<br><br><br><br><br><br><br><br><br><br>
       		<span class="sub-text mb-3 d-block" style="color:#0F4C81; font-size:500%; font-weight:900; ">↓</span>
      ...
      <div class="container">
        <div class="row align-items-center mb-5 pb-5">
          <div class="col-lg-7 img-years mb-5 mb-lg-0">
            <img src="resources/images/hero_bg_1.jpg" alt="Image" class="img-fluid">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="person">
              <div class="bio-img">
                <figure>
                  <img src="resources/images/person_5.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="social">
                  <a href="#"><span class="icon-facebook"></span></a>
                  <a href="#"><span class="icon-twitter"></span></a>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="person">
              <div class="bio-img">
                <figure>
                  <img src="resources/images/person_6.jpg" alt="Image" class="img-fluid">
                </figure>
                <div class="social">
                  <a href="#"><span class="icon-facebook"></span></a>
                  <a href="#"><span class="icon-twitter"></span></a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <img src="resources/images/about_2.jpg" alt="Image" class="img-fluid">
          </div>
...
<!--     
    ...
    <div class="site-section" id="projects-section">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 text-center">
            <span class="sub-title" style="color:#0F4C81;">Awesome Projects</span>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="resources/images/img_1.jpg" class="d-block figure" data-fancybox="gallery">
          ...
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="resources/images/img_4.jpg" class="d-block figure" data-fancybox="gallery">
          ...
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="resources/images/img_5.jpg" class="d-block figure" data-fancybox="gallery">
          ...
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="resources/images/img_6.jpg" class="d-block figure" data-fancybox="gallery">
              <img src="resources/images/img_1.jpg" alt="Image" class="img-fluid">
            </a>
            <h3 class="mb-0"><a href="#">Butterfly House</a></h3>
            <span class="text-muted">Interior</span>
              ...
              <div class="block-25">
                <ul class="list-unstyled">
                  ...
                  <li class="mb-3">
                    <a href="#" class="d-flex">
                      <figure class="image mr-4">
                        <img src="resources/images/img_4.jpg" alt="" class="img-fluid">
                      </figure>
                      <div class="text">
                        <span class="small text-uppercase date">Jan 16, 2018</span>
                        <h3 class="heading font-weight-light">Lorem ipsum dolor sit amet consectetur elit</h3>
